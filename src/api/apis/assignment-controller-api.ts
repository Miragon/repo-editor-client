...
import {AssignmentWithUserNameTO, UserInfoTO} from '../models';
import {AssignmentTO} from "../models/assignment-to";
...
export const AssignmentControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getCurrentUser(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await AssignmentControllerApiAxiosParamCreator(configuration).getCurrentUser(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const AssignmentControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getCurrentUser(options?: any): AxiosPromise<void> {
            return AssignmentControllerApiFp(configuration).getCurrentUser(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AssignmentControllerApi extends BaseAPI {
    ...
    public getCurrentUser(options?: any) {
        return AssignmentControllerApiFp(this.configuration).getCurrentUser(options).then((request) => request(this.axios, this.basePath));
    }
}
